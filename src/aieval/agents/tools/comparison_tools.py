        ...
        try:
            ...
            if isinstance(eval_result1_data, dict):
                ...
                eval_result1 = EvalResult(
                    ...
                    created_at=datetime.fromisoformat(eval_result1_data["created_at"])
                    if isinstance(eval_result1_data.get("created_at"), str)
                    else eval_result1_data.get("created_at", datetime.now()),
                )
            else:
            ...
            if isinstance(eval_result2_data, dict):
                ...
                eval_result2 = EvalResult(
                    ...
                    created_at=datetime.fromisoformat(eval_result2_data["created_at"])
                    if isinstance(eval_result2_data.get("created_at"), str)
                    else eval_result2_data.get("created_at", datetime.now()),
                )
            else:
