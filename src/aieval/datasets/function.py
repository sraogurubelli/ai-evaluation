...
def load_function_dataset(
    generator: Callable[[], list[dict[str, Any] | DatasetItem]],
) -> list[DatasetItem]:
    """Load dataset items from a generator function. Returns list of DatasetItem."""
    return FunctionDataset(generator).load()
